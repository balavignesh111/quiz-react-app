...
const QuizStartQuestion = () => {
  return ( 
    <div className="absolute w-full min-h-full top-0 left-0 bg-[rgb(0,0,0,0.7)] flex flex-col justify-center items-center hidden">
        <div className="w-[30rem] h-[23rem] bg-white rounded-lg">
          <div className="w-full h-12 bg-gray-700 px-8 flex flex-row justify-between items-center text-[#d6d8da]">
            ...
            <button className=""><IoMdCloseCircle className="text-[1.5rem]"/></button>
          </div>
